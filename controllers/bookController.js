...
exports.book_create_post = [
    ...
    body('genre.*').escape(), //We then use a wildcard (*) in the sanitiser to individually validate each of the genre array entries.
    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            async.parallel({
                ...
                // In order to mark the genres that were checked by the user 
                // we iterate through all the genres and add the checked='true' parameter
                // to those that were in our post data (as reproduced in the code fragment below).
